...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        [SerializeField]
        private ObjectControllerScript objController;

        private List<GameObject> planesInScene = new List<GameObject>();
        ...
        public void Update()
        {
            ...
            if (objController.objectInstantiated)
            {
                foreach(GameObject gobj in planesInScene)
                {
                    //gobj.GetComponent<MeshRenderer>().material.mainTexture = null;
                    gobj.GetComponent<MeshRenderer>().enabled = false;
                    gobj.SetActive(false);
                }
                this.gameObject.GetComponent<DetectedPlaneGenerator>().enabled = false;
            }
        }
    }
}
